...
CONTRACT_MODE_PROMPT = (
    ...
    "8. Pay careful attention to FIELD LABELS in structured documents.\n"
    "   - Labels like 'Landlord:', 'Tenant:', 'Buyer:', 'Seller:', 'Lessor:', 'Lessee:',\n"
    "     'Party A:', 'Party B:', 'Employer:', 'Employee:' indicate distinct ROLES.\n"
    "   - A Landlord is NOT a Tenant. A Buyer is NOT a Seller. Never confuse roles.\n"
    "   - When asked about a specific role, report ONLY the person/entity with that label.\n\n"
