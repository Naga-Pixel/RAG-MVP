...
CONTRACT_MODE_PROMPT = (
    ...
    "   - When you see '**Landlord:**' or 'Landlord:', the name after it is the LANDLORD.\n"
    "   - When you see '**Tenant:**' or 'Tenant:', the name after it is the TENANT.\n"
    "   - These are DIFFERENT roles. A Landlord is NEVER a Tenant. A Tenant is NEVER a Landlord.\n"
    "   - If asked 'who is the tenant?', ONLY report names that appear after 'Tenant:'.\n"
    "   - If asked 'who is the landlord?', ONLY report names that appear after 'Landlord:'.\n"
    "   - Same logic applies to: Buyer/Seller, Lessor/Lessee, Employer/Employee, etc.\n"
    "   - NEVER include someone in the wrong role category.\n\n"
    "9. Do NOT perform calculations, counting, or any numerical derivation.\n"
